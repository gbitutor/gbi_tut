...
\begin{frame}
	...
	\begin{block}{Beispiel 1}
		...
		\begin{itemize} 
          \item alle Wörter über $A=\{a,b\}$ \pause
          \item also $L(G)= \{ a,b\} ^*$
	  	\end{itemize}
	  \end{itemize}
	\end{block} \pause
		...
		\begin{itemize}
			...
			\item Ja \pause
			 \begin{itemize}
				...
				\item aber leeres Alphabet ($T= \{ \} $) nicht zulässig 
			\end{itemize}
		\end{itemize}
	\end{block}
...
\begin{frame}
	\frametitle{Aufgaben für euch}
	\begin{block}{Aufgabe 1}
		\begin{itemize}
			\item Sei $ T=\{ a,b \} $. Erstellt eine Grammatik, in der alle Wörter über	T, die {\bf baa} enthalten, vorkommen! 
...
\begin{frame}
	...
	\begin{itemize}
		...
		\visible<3->{\item Was lässt sich aus ihnen ableiten?}
	\end{itemize}
	\end{block}
